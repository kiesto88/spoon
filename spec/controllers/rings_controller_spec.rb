...
describe RingsController do
  ...
  # Ring. As you add validations to Ring, be sure to
  ...
  # RingsController. Be sure to keep this updated too.
  def valid_session
    {}
  end
  ...
  describe "GET index" do
    it "assigns all rings as @rings" do
      ring = Ring.create! valid_attributes
  ...
  describe "GET show" do
    it "assigns the requested ring as @ring" do
      ring = Ring.create! valid_attributes
      get :show, {:id => ring.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested ring as @ring" do
      ring = Ring.create! valid_attributes
      get :edit, {:id => ring.to_param}, valid_session
      assigns(:ring).should eq(ring)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Ring" do
        expect {
          post :create, {:ring => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ring as @ring" do
        ...
        post :create, {:ring => {}}, valid_session
        assigns(:ring).should be_a_new(Ring)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ring" do
        ...
        put :update, {:id => ring.to_param, :ring => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested ring as @ring" do
        ring = Ring.create! valid_attributes
        put :update, {:id => ring.to_param, :ring => valid_attributes}, valid_session
        assigns(:ring).should eq(ring)
      end
    ...
    describe "with invalid params" do
      it "assigns the ring as @ring" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ring.any_instance.stub(:save).and_return(false)
        put :update, {:id => ring.to_param, :ring => {}}, valid_session
        assigns(:ring).should eq(ring)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested ring" do
      ring = Ring.create! valid_attributes
      expect {
        delete :destroy, {:id => ring.to_param}, valid_session
      }.to change(Ring, :count).by(-1)
    end
